...
class TitlesControllerTest < ActionController::TestCase
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post :create, title: { content: @title.content, created_by_user: @title.created_by_user, date: @title.date }
    end
  ...
  test "should update title" do
    patch :update, id: @title, title: { content: @title.content, created_by_user: @title.created_by_user, date: @title.date }
    assert_redirected_to title_path(assigns(:title))
  end
